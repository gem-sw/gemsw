...
#process.DQMDAQ = DQMEDAnalyzer("MyQC8DAQStatusSource") 
#process.DQMRecHit = DQMEDAnalyzer("MyQC8RecHitSource")

process.MyDQMDAQ = DQMEDAnalyzer("MyQC8DAQStatusSource") 
process.MyDQMRecHit = DQMEDAnalyzer("MyQC8RecHitSource")
...
process.DQM_step = cms.Path(process.MyDQMDAQ *process.MyDQMRecHit)
