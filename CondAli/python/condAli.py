...
process.tbgemrcd = cms.EDAnalyzer("TBGEMRcdMaker",
    xShift1=cms.double(-0.269035),
    yShift1=cms.double(-2.06244),
    phiShift1=cms.double(0.),
    xShift2=cms.double(+0.292939),
    yShift2=cms.double(-0.207079),
    phiShift2=cms.double(0.),
    xShift3=cms.double(-0.332708),
    yShift3=cms.double(+0.577936),
    phiShift3=cms.double(0.),
    xShift4=cms.double(+0.0905448),
    yShift4=cms.double(+0.108215),
